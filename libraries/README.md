...
### If you have never used Arduino IDE before
1. Install Arduino IDE by following Arduino's tutorial. 
Everything in this repository is formatted such that you can simply copy all of its contents to the Arduino folder generated by Arduino IDE. 
