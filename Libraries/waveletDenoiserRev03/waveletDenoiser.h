...
#define BLOCK_SIZE 256 // number of input samples per call

// delays to compensate inside the filterbank
#define DELAY1 5

// delays for overlapping samples
#define IDX_OFFSET 15 // BLOCK_SIZE - TOT_DELAY
#define TOT_DELAY 241 // total delay between the orignal and filterbank output signal
...
void hardThr(float32_t *input, uint32_t size); // this function performs hard thresholding
